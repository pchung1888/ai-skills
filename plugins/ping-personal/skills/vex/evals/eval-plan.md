# Eval Plan -- vex persona wrapper

## Target Behavior

The wrapper exposes Vex to Codex while keeping `plugins/ping-personal/agents/vex.md` as the canonical source.
...
`pwsh plugins/ping-personal/skills/vex/evals/eval.ps1` must print `EVAL PASS vex persona wrapper`.
