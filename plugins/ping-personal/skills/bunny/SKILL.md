...
name: bunny
model: sonnet
description: Codex-compatible wrapper for the Bunny persona (implementation engineer). Trigger when the user mentions "Bunny", "@Bunny", or asks for this persona by role. Reads the canonical persona source from ../../agents/bunny.md and follows it exactly.
---

# Bunny Persona Wrapper

This skill exposes the Claude-native Bunny persona to Codex while keeping a
