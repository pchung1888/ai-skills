...
`/personal-goal-next <slug> --phase <N> --outcome <PASS|FAIL|BLOCKED> --tokens <N> --duration <minutes> --commit <sha> --subagent <name> [--notes "<text>"]`
...
2. For per-phase advance:
   - `python ${CLAUDE_PLUGIN_ROOT}/skills/personal-goal-next/lib/advance.py --beacon <p> --phase <N> --outcome <O> --tokens <T> --duration <D> --commit <S> --subagent <A> [--notes <X>]`
