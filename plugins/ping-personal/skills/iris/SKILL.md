...
name: iris
model: sonnet
description: Codex-compatible wrapper for the Iris persona (read-only researcher). Trigger when the user mentions "Iris", "@Iris", or asks for this persona by role. Reads the canonical persona source from ../../agents/iris.md and follows it exactly.
---

# Iris Persona Wrapper

This skill exposes the Claude-native Iris persona to Codex while keeping a
