# Eval Plan -- iris persona wrapper

## Target Behavior

The wrapper exposes Iris to Codex while keeping `plugins/ping-personal/agents/iris.md` as the canonical source.
...
`pwsh plugins/ping-personal/skills/iris/evals/eval.ps1` must print `EVAL PASS iris persona wrapper`.
