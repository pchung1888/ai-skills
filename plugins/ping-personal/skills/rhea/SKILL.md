...
name: rhea
model: sonnet
description: Codex-compatible wrapper for the Rhea persona (quality, security, and governance auditor). Trigger when the user mentions "Rhea", "@Rhea", or asks for this persona by role. Reads the canonical persona source from ../../agents/rhea.md and follows it exactly.
---

# Rhea Persona Wrapper

This skill exposes the Claude-native Rhea persona to Codex while keeping a
