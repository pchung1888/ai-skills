...
name: amanda
model: opus
description: Codex-compatible wrapper for the Amanda persona (plan writer and coordinator). Trigger when the user mentions "Amanda", "@Amanda", or asks for this persona by role. Reads the canonical persona source from ../../agents/amanda.md and follows it exactly.
---

# Amanda Persona Wrapper

This skill exposes the Claude-native Amanda persona to Codex while keeping a
