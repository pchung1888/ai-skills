...
name: dora
model: sonnet
description: Codex-compatible wrapper for the Dora persona (git and PR sentinel). Trigger when the user mentions "Dora", "@Dora", or asks for this persona by role. Reads the canonical persona source from ../../agents/dora.md and follows it exactly.
---

# Dora Persona Wrapper

This skill exposes the Claude-native Dora persona to Codex while keeping a
